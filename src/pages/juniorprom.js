  ...
  <div>
    ...
    <div className="work-container">
      <div className="project-intro">
        <div>
          Brand + Identity Design Year: 2021 <br></br> Photographer: Kendra
          Frankle <br></br> Models: Brianna Roberts, Sophie Berner, Ynessa
          Rhodes
        </div>
        <div>
          Branding for an indie-pop band. This project involved establishing a
          brand and band identity, vinyl design, various merchandise, and
          advertisements. Junior Prom as both a band and a brand evokes
          excitement and a unique style.
        </div>
      </div>
